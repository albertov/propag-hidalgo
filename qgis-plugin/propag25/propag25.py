...
class Propag25:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Propag25', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/propag25/flame.svg'
        self.add_action(
            icon_path,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = Propag25DockWidget()
